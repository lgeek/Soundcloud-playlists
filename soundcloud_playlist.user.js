...
$(function () {
  ...
  // Add to playlist UI stuff begins here
  ...
  // Add to playlist UI stuff ends here
});

// Playlist UI starts here
function generate_player(position, track_id, duration, waveform, user_name, user_permalink, track_permalink_url, track_title, stream_url) {
...
function generate_track(position, track_id, track_name, user_name, permalink_url, duration, play_count) {
  var minutes = parseInt(duration/60000);
...
// Playlist UI ends here

// Data operation start here
...
function add_track_to_playlist(track, playlist_id) {
...
function remove_track_from_playlist(track, playlist_id) {
  var tracks = $.parseJSON(localStorage.getItem('playlist_'+playlist_id));
...
// Data operation end here

// Helpers
function get_playing_track() {
  return $('ol.tracks li.playing');
}

function get_playing_playlist_entry() {
  return get_playing_track().closest('li.set');
}

function get_playing_playlist() {
